  ...
  return (
    <div className="container mt-5">
      ...
      <div className="d-flex justify-content-start gap-3 mt-4">
        <button className="btn btn-secondary mt-3" onClick={() => navigate("/admin-edit-profile")}>
          プロフィール編集
        </button>
        <button className="btn btn-outline-info" onClick={() => navigate("/admin/dashboard")}>
          メインページ
        </button>
      </div>
    </div>
